...
require_once 'freedompay/PG_Signature.php';
...
if (defined('PAYMENT_NOTIFICATION')) {
    ...
    $form_fields = array(
        ...
        'pg_check_url'      => 'http://' . $_SERVER['HTTP_HOST'] . '/index.php?dispatch=payment_notification.check&payment=freedompay',
        'pg_result_url'     => 'http://' . $_SERVER['HTTP_HOST'] . '/index.php?dispatch=payment_notification.result&payment=freedompay',
        'pg_request_method' => 'GET',
        'pg_success_url'    => 'http://' . $_SERVER['HTTP_HOST'] . '/index.php?dispatch=payment_notification.success&payment=freedompay',
        'pg_failure_url'    => 'http://' . $_SERVER['HTTP_HOST'] . '/index.php?dispatch=payment_notification.fail&payment=freedompay',
    ...
    fn_create_payment_form('https://api.freedompay.money/payment.php', $form_fields, 'freedompay', false);
}
